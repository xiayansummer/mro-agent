...
def _raw():
    return {"name": "3M 防尘口罩，9501V+ 售卖规格：1只", "brand": "3M",
            ...
            "url": "https://www.ehsy.com/product-CMN420", "delivery": "7个工作日",
            "image": "https://image-c.ehsy.com/uploadfile/x_M.jpg", "source": "西域"}
...
def test_map_normal():
    ...
    assert o["imageUrl"] == "https://image-c.ehsy.com/uploadfile/x_M.jpg"


def test_map_missing_image():
    r = _raw(); r["image"] = None
    assert _to_external_offer(r, 0)["imageUrl"] is None
